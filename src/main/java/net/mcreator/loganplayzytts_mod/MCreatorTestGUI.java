...
public class MCreatorTestGUI extends Elementsloganplayzytts_mod.ModElement {
	public static int GUIID = 1;
	public static HashMap guiinventory = new HashMap();

	public MCreatorTestGUI(Elementsloganplayzytts_mod instance) {
		super(instance, 1);
	}
	...
	public static class GuiContainerMod extends Container {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				loganplayzytts_mod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("loganplayzytts_mod:textures/testgui.png");
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 39, this.guiTop + 15, 90, 20, "Subscribe"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			loganplayzytts_mod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
